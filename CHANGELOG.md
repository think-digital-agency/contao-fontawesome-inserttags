...
### Changed
- **Contao 6 support.** `contao/core-bundle` constraint widened to `^5.3 || ^6.0`. No API changes — the bundle uses the modern `#[AsInsertTag]` attribute; verified functional on Contao 6.0 / Symfony 8.1.

## [1.0.2] - 2026-06-16

### Documentation
- Add LGPL-3.0-or-later LICENSE file
